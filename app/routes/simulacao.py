...
def simular():
    ...
    try:
        ...
        dados_base = {
            ...
            'fumante': int(paciente['fumante']) if paciente else 0,
            'doenca_cronica': int(paciente['doenca_cronica']) if paciente else 0,
            'complexidade_tratamento': paciente['complexidade_tratamento'] if paciente else 'Baixa',
        ...
        dados_consulta = {
            ...
            'fumante': 1 if _to_int('fumante', dados_base['fumante']) == 1 else 0,
            'doenca_cronica': 1 if _to_int('doenca_cronica', dados_base['doenca_cronica']) == 1 else 0,
            'complexidade_tratamento': request.form.get('complexidade_tratamento', dados_base['complexidade_tratamento']),
...
def carregar_paciente(paciente_id):
    ...
    payload = {
        ...
        'fumante': int(paciente['fumante']),
        'doenca_cronica': int(paciente['doenca_cronica']),
